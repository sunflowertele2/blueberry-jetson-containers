...
blueberry-jetson-containers run $(autotag videomambasuite)
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag videomambasuite)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag videomambasuite) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build videomambasuite
```
