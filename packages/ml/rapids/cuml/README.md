...
| **`cuml`** | |
| :-- | :-- |
| &nbsp;&nbsp;&nbsp;Builds | [![`cuml_jp51`](https://img.shields.io/github/actions/workflow/status/dusty-nv/blueberry-jetson-containers/cuml_jp51.yml?label=cuml:jp51)](https://github.com/dusty-nv/blueberry-jetson-containers/actions/workflows/cuml_jp51.yml) |
| &nbsp;&nbsp;&nbsp;Requires | `L4T ['>=34.1.0']` |
...
blueberry-jetson-containers run $(autotag cuml)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/cuml:r35.4.1
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag cuml)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag cuml) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build cuml
```
