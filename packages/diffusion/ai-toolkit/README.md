...
blueberry-jetson-containers run $(autotag ai-toolkit)
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag ai-toolkit)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag ai-toolkit) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build ai-toolkit
```
