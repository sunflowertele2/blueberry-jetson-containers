...
blueberry-jetson-containers run $(autotag assist-microphone)
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag assist-microphone)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag assist-microphone) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build assist-microphone
```
