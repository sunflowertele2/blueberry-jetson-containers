...
blueberry-jetson-containers run $(autotag build-essential)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/build-essential:r35.4.1
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag build-essential)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag build-essential) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build build-essential
```
