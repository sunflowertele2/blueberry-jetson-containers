...
| **`l4t-diffusion`** | |
| :-- | :-- |
| &nbsp;&nbsp;&nbsp;Builds | [![`l4t-diffusion_jp51`](https://img.shields.io/github/actions/workflow/status/dusty-nv/blueberry-jetson-containers/l4t-diffusion_jp51.yml?label=l4t-diffusion:jp51)](https://github.com/dusty-nv/blueberry-jetson-containers/actions/workflows/l4t-diffusion_jp51.yml) |
| &nbsp;&nbsp;&nbsp;Requires | `L4T ['>=34.1.0']` |
...
blueberry-jetson-containers run $(autotag l4t-diffusion)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/l4t-diffusion:r35.4.1
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag l4t-diffusion)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag l4t-diffusion) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build l4t-diffusion
```
