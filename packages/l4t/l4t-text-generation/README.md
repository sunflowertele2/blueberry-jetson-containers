...
blueberry-jetson-containers run $(autotag l4t-text-generation)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/l4t-text-generation:r36.2.0
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag l4t-text-generation)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag l4t-text-generation) my_app --abc xyz
```
