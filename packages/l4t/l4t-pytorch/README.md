...
blueberry-jetson-containers run dustynv/l4t-pytorch:r36.2.0
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag l4t-pytorch)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag l4t-pytorch) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build l4t-pytorch
```
