...
blueberry-jetson-containers run $(autotag minigpt4)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/minigpt4:r35.3.1
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag minigpt4)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag minigpt4) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build minigpt4
```
