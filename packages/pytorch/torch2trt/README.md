...
| **`torch2trt`** | |
| :-- | :-- |
| &nbsp;&nbsp;&nbsp;Builds | [![`torch2trt_jp51`](https://img.shields.io/github/actions/workflow/status/dusty-nv/blueberry-jetson-containers/torch2trt_jp51.yml?label=torch2trt:jp51)](https://github.com/dusty-nv/blueberry-jetson-containers/actions/workflows/torch2trt_jp51.yml) [![`torch2trt_jp46`](https://img.shields.io/github/actions/workflow/status/dusty-nv/blueberry-jetson-containers/torch2trt_jp46.yml?label=torch2trt:jp46)](https://github.com/dusty-nv/blueberry-jetson-containers/actions/workflows/torch2trt_jp46.yml) |
| &nbsp;&nbsp;&nbsp;Requires | `L4T ['>=32.6']` |
...
blueberry-jetson-containers run $(autotag torch2trt)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/torch2trt:r35.2.1
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag torch2trt)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag torch2trt) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build torch2trt
```
