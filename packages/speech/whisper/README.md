...
| **`whisper`** | |
| :-- | :-- |
| &nbsp;&nbsp;&nbsp;Builds | [![`whisper_jp60`](https://img.shields.io/github/actions/workflow/status/dusty-nv/blueberry-jetson-containers/whisper_jp60.yml?label=whisper:jp60)](https://github.com/dusty-nv/blueberry-jetson-containers/actions/workflows/whisper_jp60.yml) [![`whisper_jp51`](https://img.shields.io/github/actions/workflow/status/dusty-nv/blueberry-jetson-containers/whisper_jp51.yml?label=whisper:jp51)](https://github.com/dusty-nv/blueberry-jetson-containers/actions/workflows/whisper_jp51.yml) |
| &nbsp;&nbsp;&nbsp;Requires | `L4T ['>=34.1.0']` |
...
blueberry-jetson-containers run $(autotag whisper)

# or explicitly specify one of the container images above
blueberry-jetson-containers run dustynv/whisper:r35.3.1
...
```bash
blueberry-jetson-containers run -v /path/on/host:/path/in/container $(autotag whisper)
```
To launch the container running a command, as opposed to an interactive shell:
```bash
blueberry-jetson-containers run $(autotag whisper) my_app --abc xyz
```
...
```bash
blueberry-jetson-containers build whisper
```
